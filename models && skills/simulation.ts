...
function extractNoun(input: string): string {
...
function extractWhoPhrase(input: string): string {
...
function extractWhyPhrase(input: string): string {
...
function extractHowPhrase(input: string): string {
...
function extractWherePhrase(input: string): string {
...
function computeConfidence(input: string, verb: string): number {
...
function crossCheckPlan(plan: string[], intent: IntentAnalysis): string[] {
  const checks: string[] = [];
  if (plan.length === 0) {
...
function detectErrors(plan: string[], intent: IntentAnalysis): string[] {
  const errors: string[] = [];
...
function buildOutput(plan: string[], intent: IntentAnalysis): string {
  const lines: string[] = [];
...
function buildPlan(intent: IntentAnalysis): string[] {
  const plan: string[] = [];
...
export class SimulationEngine {
  ...
  run(input: string, maxIterations: number = 3): FinalOutput {
