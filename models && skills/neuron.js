export class Neuron {
    ...
    expertGroup;
    active;
    constructor(name, value = 0, totalValuePoints = 1000) {
    ...
    connectTo(targetNeuronId, weight) {
        this.connections.set(targetNeuronId, weight);
    }
    disconnectFrom(targetNeuronId) {
    ...
    setAsExpert() { this.expertGroup = 1; }
    setAsPlugin() { this.expertGroup = 2; }
    getSerializedState() {
    ...
    static fromSerializedState(serialized) {
        ...
        n.expertGroup = data.expertGroup;
