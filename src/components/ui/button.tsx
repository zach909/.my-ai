...
const buttonVariants = cva(
  ...
  // "active:scale-95 transition-all duration-150" onto their own buttons
  // (most did; plenty didn't) -- every button gets the same tactile press
  // feedback now, consistently, including every one nobody thought to add
  // it to by hand.
