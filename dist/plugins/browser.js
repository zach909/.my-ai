...
export class BrowserPlugin extends BasePlugin {
    ...
    async onMessage(message) {
        ...
        if (/\b(read|write|list|exists?|mkdir|delete)\b/.test(lower))
            return null;
