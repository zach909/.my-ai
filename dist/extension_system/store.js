...
export class ExtensionStore {
    ...
    async write(id, version, payload, opts = {}) {
        ...
        if (compress)
            encoded = await gzipBuffer(encoded);
    ...
    async read(id, version, encoding) {
    ...
    async verify(id, version, encoding) {
        if (encoding.quantization)
            return existsSync(join(this.dir(id, version), "payload.bin"));
